...
Fixed::Fixed() : _fixed(0) { std::cout << COLOR_Y << CONSTRUCTOR << COLOR_END << std::endl; }
Fixed::~Fixed() { std::cout << COLOR_Y << DESTRUCTOR << COLOR_END << std::endl; }
...
int Fixed::getRawBits(void) const {
    return std::cout << COLOR_Y << GETRAWBITS << COLOR_END << std::endl, _fixed;
}
